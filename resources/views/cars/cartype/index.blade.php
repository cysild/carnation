           ...
           $("#add-data").show();
            ...
            $.ajax({
              ...
              var appendimg = '';
                ...
                appendimg += '<a data-act="ajax-del-id" href ="#"> <img class="img" src="'+imageurl+data.html.image+'" width="50px;"/></a>';
            
                 $('.images').empty().append(''+appendimg);
                $('.image').empty().append('<input type="hidden" name="img" value="'+data.html.image+'"/>');
              }
